  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between px-4 md:px-8 h-14 bg-[#0a0f1d]/60 backdrop-blur-3xl border-b border-white/5">
      ...
      <div className="flex items-center gap-1.5 line-height-none relative" ref={dropdownRef}>
        ...
        {showNotifications && (
          <div className="absolute top-12 right-0 w-[calc(100vw-2rem)] sm:w-[320px] max-w-[320px] bg-[#0c1225]/95 backdrop-blur-3xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 z-50">
