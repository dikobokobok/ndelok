...
export default function Projects() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 max-w-[1600px] mx-auto animate-in">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-on-surface">Project Registry</h2>
          <p className="text-slate-500 mt-2 text-xs sm:text-sm">Monitor health and track background services.</p>
        </div>
      ...
      <div className={`grid gap-3 sm:gap-4 ${view === 'grid' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>
        {projectList.map(p => (
